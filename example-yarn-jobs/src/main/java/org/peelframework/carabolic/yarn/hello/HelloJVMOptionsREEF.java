...
import org.peelframework.carabolic.yarn.hello.HelloJVMOptionsDriver;
...
public final class HelloJVMOptionsREEF {
  private static final Logger LOG = Logger.getLogger(HelloJVMOptionsREEF.class.getName());
  ...
  private static Configuration getDriverConfiguration() {
    return DriverConfiguration.CONF
        ...
        .set(DriverConfiguration.ON_EVALUATOR_ALLOCATED, HelloJVMOptionsDriver.EvaluatorAllocatedHandler.class)
        .build();
  }
